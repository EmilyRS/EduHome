<div class="x_panel">
	<div class="x_title">
	    <h2 style="margin-top: 10px;">All Menus</h2>
							...
							<table id="datatable" class="table table-striped jambo_table bulk_action text-center">
			                   ...
			                   <?php if(count($menus)): foreach($menus as $menu): ?>	
			                      <tr class="even pointer">
			                        ...
			                        <td><?php echo anchor('admin/menu_items/index/'.$menu->id_menu, $menu->title); ?></td>
									<td><?php echo $menu->description; ?></td>
									<td><?php echo btn_edit('admin/menu/edit/' . $menu->id_menu); ?></td>
									<td><?php echo btn_delete('admin/menu/delete/' . $menu->id_menu); ?></td>
			                        </td>
			                      </tr>
			                    <?php endforeach; ?>
							   <?php else: ?>
									<tr>
										<td colspan="3">We could not find any Menus.</td>
									</tr>
							   <?php endif; ?>	
