<div class="x_panel">
	<div class="x_title">
	    <h2 style="margin-top: 10px;">All Categories</h2>
	    <div class="pull-right" >
            <button  onclick="window.location='<?php echo base_url("index.php/admin/category/edit");?>'" type="button" class="btn btn-md btn-primary"><li class="glyphicon glyphicon-plus" ></li> Add</button>
			                      ...
			                      <tr class="even pointer">
			                        <td class="a-center " align="left" style="width: 5px;">
			                          <input type="checkbox" class="flat" name="table_records">
				                        ...
				                        <td><?php echo anchor('admin/category/edit/'.$category->id_category, $category->title); ?></td>
									    <td><?php echo btn_edit('admin/category/edit/' . $category->id_category); ?></td>
										<td><?php echo btn_delete('admin/category/delete/' . $category->id_category); ?></td>
