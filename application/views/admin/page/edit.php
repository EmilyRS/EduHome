<h3><?php echo empty($page->id_page) ? 'Add a new page' : 'Edit page ' . $page->title; ?></h3>
...
<table class="table">
	...
	<tr>
		<td>Body</td>
		<td><?php echo form_textarea('body', set_value('body', $page->body),'class="form-control editor tinymce"'); ?></td>
	</tr>
	<tr>
		<td></td>
