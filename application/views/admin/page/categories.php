<div class="x_panel">
	<div class="x_title">
	    ...
	    <div class="pull-right" >
            <button  onclick="window.location='<?php echo base_url("index.php/admin/page/addCategory");?>'" type="button" class="btn btn-md btn-primary"><li class="glyphicon glyphicon-plus" ></li> Add</button>
							...
							<table id="datatable" class="table table-striped jambo_table bulk_action text-center">
			                    <thead>
			                      <tr class="headings">
									...
									<th class="column-title text-center">Menu Item</th>
									<th class="column-title text-center">Parent category</th>
