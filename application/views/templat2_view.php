...
_________________________________________________________ -->
    ...
    _________________________________________________________ -->
        ...
        <div id="content">
        	<section id="Type2"class="bar background-white no-mb sec">
            <div class="container-fluid">
                    <div class="row">
                      <div class="heading text-center">
                        <h2 id="Type2_title" contenteditable="true">My courses</h2>
                      </div>
                    </div>
                    <div  class="row type2_item">
                        <div class="col-lg-10 col-md-10 col-lg-offset-1 col-md-offset-1">
		                            <div class="row">
		                                <div class="col-lg-4 col-md-4">
		                                    <div class="box-image" >
				                                <div class="image">
				                                    <img src="<?php echo base_url();?>img/portfolio-2.jpg" alt="" class="img-responsive">
				                                </div>
				                                <div class="bg"></div>
				                                <div class="text" >
				                                    <div class="row " >
		                                ...
		                                <div class="col-md-7">
		                                    <h2 id="type2_item_title1"  contenteditable="true"><a href="post.htmls">Fashion now</a></h2>
		                                    <p  id="type2_item_desc1"  class="intro" contenteditable="true">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper.
                    ...
                    <div  class="row type2_item">
                        <div class="col-lg-10 col-md-10 col-lg-offset-1 col-md-offset-1">
		                            <div class="row">
		                                ...
		                                <div class="col-md-7">
		                                    <h2 id="type2_item_title2"  contenteditable="true"><a href="post.htmls">Fashion now</a></h2>
		                                    <p  id="type2_item_desc2"  class="intro" contenteditable="true">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper.
		                                        Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
		                                    </p>
		                                </div>
		                            </div>
                    ...
                    <div  class="row type2_item">
                        <div class="col-lg-10 col-md-10 col-lg-offset-1 col-md-offset-1">
		                            <div class="row">
		                                ...
		                                <div class="col-md-7">
		                                    <h2 id="type2_item_title3"  contenteditable="true"><a href="post.htmls">Fashion now</a></h2>
		                                    <p  id="type2_item_desc3"  class="intro" contenteditable="true">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper.
		                                        Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
		                                    </p>
		                                </div>
		                            </div>
                    ...
                    <div class="btnAdd1">
                     	<button onclick="addToType1()" class="btn btn-primary" style="width: 100%; height: 60px; background-color:rgba(0,0,0,0.5);"><span class="fa fa-plus" style=" font-size: 4em;"></span></button>
		           </div>
                </section>
        </div>
        <footer id="footer">
