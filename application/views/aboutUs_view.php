                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse3a" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="<?php echo base_url();?>img/template-easy-customize.png" alt="" class="img-responsive">
                                                </div>
                                                <div class="col-md-8">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse3b" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="<?php echo base_url();?>img/template-easy-code.png" alt="" class="img-responsive">
                                                </div>
                                                <div class="col-md-8">
